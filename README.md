...
The text **"Eashwar "** is added to the blank image using OpenCV's `cv2.putText()` function.
...
<img width="485" height="510" alt="image" src="https://github.com/user-attachments/assets/60799a6f-68d4-4f00-8ab2-ace44946e2e2" />
...
**Eroded Image**
<img width="482" height="511" alt="image" src="https://github.com/user-attachments/assets/816b7b8e-4789-4395-b3d9-563d5777df79" />
...
**Dilated Image**
<img width="492" height="505" alt="image" src="https://github.com/user-attachments/assets/83e5b159-1d6f-48c8-8621-3eca9da68bcd" />
...
A blank image was created using NumPy, the text **"Eashwar "** was added using `cv2.putText()`, and a **3×3 square kernel** was used to perform erosion and dilation. Erosion reduced the thickness of the text, while dilation increased its thickness.
